...
function getObj() {
  ...
  // make this true to dump to disk
  if (3 < 2) {
    const fs = require('fs');
    fs.writeFileSync('/tmp/answer.txt', JSON.stringify(ret, null, 2));
  }
...
let answer = [
  ...
  {
    "name": {
      "english": "Arresterdramon X MetalTyrannomon"
    },
    "color": "",
    "cardType": "Digimon",
    "playCost": "8",
  ...
  {
    "name": {
      "english": "Kentaurosmon (X Antibody)"
    },
    "color": "Yellow/Blue",
    "cardType": "Digimon",
    "playCost": "12",
